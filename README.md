...
In the patched-pages, login.php uses pdo to access to the database to prevent SQL injection. And comments.php uses htmlentities function when inserting comment to database to prevent XSS attacks.
